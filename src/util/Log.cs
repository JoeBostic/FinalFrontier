...
namespace Nereid
{
	namespace FinalFrontier
	{
		public static class Log
		{
			...
			{
				if (IsLogable(LEVEL.TRACE)) Debug.Log(PREFIX + msg);
			}

			public static void Detail(string msg)
			{
				if (IsLogable(LEVEL.DETAIL)) Debug.Log(PREFIX + msg);
			}


			public static void Info(string msg)
			{
				if (IsLogable(LEVEL.INFO)) Debug.Log(PREFIX + msg);
			}

			// for debuging only; calls should be removed for release
			public static void Test(string msg)
			{
				if (IsLogable(LEVEL.INFO)) Debug.LogWarning(PREFIX + "TEST:" + msg);
			}

			public static void Warning(string msg)
			{
				if (IsLogable(LEVEL.WARNING)) Debug.LogWarning(PREFIX + msg);
			}

			public static void Error(string msg)
			{
				if (IsLogable(LEVEL.ERROR)) Debug.LogError(PREFIX + msg);
			}
			...
			public static void LogAchievement(Achievement achievement, HallOfFameEntry entry)
			{
				...
				var visitedCelestialBodies = "";
				foreach (var body in entry.visitedCelestialBodies) visitedCelestialBodies = visitedCelestialBodies + body.name + " ";
				Debug.Log("  - visitedCelestialBodies: " + visitedCelestialBodies);
				Debug.Log("+ - end -");
			}

			public static void LogAchievement(Achievement achievement, Contract contract)
			{
